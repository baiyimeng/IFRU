...
class influence_unlearn(nn.Module):
    ...
    def compute_hessian_with_test(self, model=None, data_generator=None):
        ...
        def unlearn_loss_fun_nochange(para1, para2):  # 用于求random上的loss
            u_para, i_para = para1, para2
        ...
        ## scif
        label_path = 'Data/Process/BookCrossing/0.01/avg_labels.npy'
...
def main(config_args):
    ...
    save_name = "Weights/LightGCN_SCIF/lightgcn_dataset_{}_attack_{}_lr_{}_khop_{}_emb_{}.pth".format(args.dataset, args.attack, args.if_lr, args.k_hop, args.embed_size)
